 ...
 */
class EAuthProfileWidget extends CWidget {
	...
	public $action = null;
        ...
        /**
	 * @var string the social_error to display social error if present.
	 */
	public $social_error = null;
    ...
    public function run() {
		...
		$this->registerAssets();
		$this->render('profile_auth', array(
			'id' => $this->getId(),
			'services' => $this->services,
			'action' => $this->action,
                        'connected_social_services' => $this->connected_social_services,
                        'social_error' => $this->social_error,
		));
    }
