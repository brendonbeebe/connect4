...
//                        $redirect_uri = preg_replace("/\&state=.*/","",$redirect_uri);
...
//        if($this->getServiceName() == "google_oauth")
//		    return $this->providerOptions['authorize'].'?client_id='.$this->client_id.'&redirect_uri='.urlencode($redirect_uri).'&scope='.$this->scope.'&response_type=code'.'&state='.$this->hashcode;
//		else
//            return $this->providerOptions['authorize'].'?client_id='.$this->client_id.'&redirect_uri='.urlencode($redirect_uri).'&scope='.$this->scope.'&response_type=code';
	}
